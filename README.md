...
# The game should start automatically when the player presses play on Visual Studio Code
# The game prints the scene
# Before options are given the player is asked to spell yes to continue
# The options are thus given afterwards
...
# In the future I intend to use more def's to create some organized code
# In the discussion posts someone pointed out that I should improve the transition from chapter 2 back to chapter 1 (option)
